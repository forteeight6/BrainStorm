        ...
        for($item3=0; $item3<sizeof($produtos_da_casas_bahia); $item3+=1)
        {
            for($item4=0; $item4<sizeof($marcas_do_smartphone_da_casas_bahia); $item4+=1)
            {
                for($item5=0; $item5<sizeof($quantidades_de_smartphones_da_casas_bahia_da_marca_del); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_smartphone_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_smartphones_da_casas_bahia_da_marca_del[$item5]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_del[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_smartphones_da_casas_bahia_da_marca_del[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_smartphone_da_casas_bahia[$item4]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_del[$item5];
                    }
                }
                for($item5=0; $item5<sizeof($quantidades_de_smartphones_da_casas_bahia_da_marca_nokia); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_smartphone_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_smartphones_da_casas_bahia_da_marca_nokia[$item5]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_nokia[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_smartphones_da_casas_bahia_da_marca_nokia[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_smartphone_da_casas_bahia[$item4]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_nokia[$item5];
                    }
                }
                for($item5=0; $item5<sizeof($quantidades_de_smartphones_da_casas_bahia_da_marca_intel); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_smartphone_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_smartphones_da_casas_bahia_da_marca_intel[$item5]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_intel[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_smartphones_da_casas_bahia_da_marca_intel[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_smartphone_da_casas_bahia[$item4]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_intel[$item5];
                    }
                }
                for($item5=0; $item5<sizeof($quantidades_de_smartphones_da_casas_bahia_da_marca_md); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_smartphone_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_smartphones_da_casas_bahia_da_marca_md[$item5]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_md[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_smartphones_da_casas_bahia_da_marca_md[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_smartphone_da_casas_bahia[$item4]] = $quantidades_de_smartphones_da_casas_bahia_da_marca_md[$item5];
                    }
                }
            }
            //TABLETS
            for($item4=0; $item4<sizeof($marcas_do_tablet_da_casas_bahia); $item4+=1)
            {
                for($item5=0; $item5<sizeof($quantidades_de_tablets_da_casas_bahia_da_marca_mongi); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_tablet_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_tablets_da_casas_bahia_da_marca_mongi[$item5]] = $quantidades_de_tablets_da_casas_bahia_da_marca_mongi[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_tablets_da_casas_bahia_da_marca_mongi[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_tablet_da_casas_bahia[$item4]] = $quantidades_de_tablets_da_casas_bahia_da_marca_mongi[$item5];
                    }
                }
                for($item5=0; $item5<sizeof($quantidades_de_tablets_da_casas_bahia_da_marca_nokia); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_tablet_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_tablets_da_casas_bahia_da_marca_nokia[$item5]] = $quantidades_de_tablets_da_casas_bahia_da_marca_nokia[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_tablets_da_casas_bahia_da_marca_nokia[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_tablet_da_casas_bahia[$item4]] = $quantidades_de_tablets_da_casas_bahia_da_marca_nokia[$item5];
                    }
                }
                for($item5=0; $item5<sizeof($quantidades_de_tablets_da_casas_bahia_da_marca_domi); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_tablet_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_tablets_da_casas_bahia_da_marca_domi[$item5]] = $quantidades_de_tablets_da_casas_bahia_da_marca_domi[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_tablets_da_casas_bahia_da_marca_domi[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_tablet_da_casas_bahia[$item4]] = $quantidades_de_tablets_da_casas_bahia_da_marca_domi[$item5];
                    }
                }
                for($item5=0; $item5<sizeof($quantidades_de_tablets_da_casas_bahia_da_marca_gim); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_tablet_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_tablets_da_casas_bahia_da_marca_gim[$item5]] = $quantidades_de_tablets_da_casas_bahia_da_marca_gim[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_tablets_da_casas_bahia_da_marca_gim[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_tablet_da_casas_bahia[$item4]] = $quantidades_de_tablets_da_casas_bahia_da_marca_gim[$item5];
                    }
                }
            }
            //NOTEBOOKS
            for($item4=0; $item4<sizeof($marcas_do_notebook_da_casas_bahia); $item4+=1)
            {
                for($item5=0; $item5<sizeof($quantidades_de_notebooks_da_casas_bahia_da_marca_sansung); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_notebook_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_notebooks_da_casas_bahia_da_marca_sansung[$item5]] = $quantidades_de_notebooks_da_casas_bahia_da_marca_sansung[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_notebooks_da_casas_bahia_da_marca_sansung[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_notebook_da_casas_bahia[$item4]] = $quantidades_de_notebooks_da_casas_bahia_da_marca_sansung[$item5];
                    }
                }
                for($item5=0; $item5<sizeof($quantidades_de_notebooks_da_casas_bahia_da_marca_positivo); $item5+=1)
                {
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$marcas_do_notebook_da_casas_bahia[$item4]][$produtos_da_casas_bahia[$item3]][$quantidades_de_notebooks_da_casas_bahia_da_marca_positivo[$item5]] = $quantidades_de_notebooks_da_casas_bahia_da_marca_positivo[$item5];
                    }
                    ...
                    {
                        $matriz[$lojas[$item]][$caracteristicas[$item2]][$quantidades_de_notebooks_da_casas_bahia_da_marca_positivo[$item5]][$produtos_da_casas_bahia[$item3]][$marcas_do_notebook_da_casas_bahia[$item4]] = $quantidades_de_notebooks_da_casas_bahia_da_marca_positivo[$item5];
                    }
                }
            }
        }
