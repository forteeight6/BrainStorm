...
# Os métodos Pool.apply e Pool.map são basicamente equivalentes às funções apply e map nativas do Python. Antes de chegarmos às variantes async dos métodos Pool, vamos dar uma olhada em um exemplo simples usando Pool.apply e Pool.map. Aqui definiremos o número de processos como 4, o que significa que a classe Pool permitirá apenas 4 processos em execução ao mesmo tempo.
